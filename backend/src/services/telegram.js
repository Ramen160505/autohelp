...
function setupTelegram() {
  ...
  bot.onText(/\/start$/, (msg) => {
    const imageUrl = 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&w=800&q=80';
    
    const text = `👋 *Привіт, я — Auto Helper, твій розумний помічник на дорозі!*\n\n` +
                 `Наша платформа — це братство водіїв, які готові виручити одне одного з біди.\n\n` +
                 `🔹 *Що ти можеш робити у нас:*\n` +
                 `🚨 **Миттєвий SOS** — зламався? 1 клік, і всі водії об'єднаються, щоб допомогти тобі!\n` +
                 `🔋 **Допомагай іншим** — отримуй сповіщення, якщо комусь поруч потрібен бензин, буксир чи акумулятор.\n` +
                 `🤝 **Рейтинг (Карма)** — заробляй подяки, підвищуй свій статус і ставай легендою доріг.\n` +
                 `💬 **Спільнота** — приєднуйся до нашого чату і завжди будь в курсі подій.\n\n` +
                 `👇 *Тисни кнопку нижче, щоб увійти в систему AutoHelp:*`;
